...
// function TestScreen({ route, navigation }: NativeStackScreenProps<RootStackParamList, 'Test'>) {
...
// 이 StackParamList는 실제 프로젝트의 RootStackParamList랑 합쳐서 쓰면 됩니다.
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity style={styles.button} onPress={handlePress}>
        <Text style={styles.buttonText}>MemoScreen(PIP)으로 이동</Text>
      </TouchableOpacity>
    </View>
  );
}
